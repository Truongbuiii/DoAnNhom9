...
<div class="container-fluid">
    ...
    <div id="formCu" style="display:none;">
        ...
        <div class="mb-3">
            <input type="text" id="TenKH_cu" class="form-control" placeholder="Tên khách hàng" readonly>
        </div>
        <div class="mb-3">
            <input type="text" id="SDT_cu" class="form-control" placeholder="Số điện thoại" readonly>
        </div>
    </div>
</form>

<script>
// Hiển thị form khách hàng mới hoặc khách hàng đã lưu
...
// Khi chọn khách hàng cũ, hiển thị vào input
